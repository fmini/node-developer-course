...
const geocode = (address, anyDangNameYouWant) => { // this gets the address and callback function defined anonymously in the geocode call and names the callback function 'callback'
  const url = 'https://api.mapbox.com/geocoding/v5/mapbox.places/'+ encodeURIComponent(address) +'.json?access_token=pk.eyJ1IjoiZm1pbmkiLCJhIjoiY2s2Zjd3YTRwMjV1dTNrcGp2ajcxcmI5dyJ9.U-F5KbekPS0viakTEellKw&limit=1'
